    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            >
                ...
                <option value="operations" @selected(old('role') === 'operations')>Operations</option>
                <option value="accountant" @selected(old('role') === 'accountant')>Accountant</option>
                <option value="customer_service" @selected(old('role') === 'customer_service')>Customer Service</option>
