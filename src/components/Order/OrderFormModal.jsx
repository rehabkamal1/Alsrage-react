...
const OrderFormModal = ({
  ...
  const [arrivalDestinationOptions, setArrivalDestinationOptions] = useState(
    [],
  );
  ...
  useEffect(() => {
    if (show) {
      ...
      getClients({ all: 1, per_page: 500 })
        ...
        .catch((err) => console.error("Error fetching local clients:", err));
      ...
      getEmployees({ all: 1, per_page: 500 })
        ...
        .catch((err) => console.error("Error fetching local employees:", err));

      Promise.all([
        getSettingsNationalities(),
        getSettingsProfessions(),
        getSettingsArrivalDestinations(),
      ]).then(([nationalitiesRes, professionsRes, destinationsRes]) => {
        ...
        setArrivalDestinationOptions(destinationsRes.data?.data || []);
      });
    }
  }, [show]);
  ...
  const handleQuickCreateEmployee = async () => {
    if (
      ...
      showError("خطأ", "يرجى إدخال الاسم والجوال واسم المستخدم وكلمة المرور");
      return;
    }
    ...
    try {
      ...
      const errorMsg =
        err.response?.data?.message || "حدث خطأ أثناء إضافة المسوق / الموظف";
      showError("خطأ", errorMsg);
    } finally {
                      ...
                      <Form.Group className="mb-3">
                        ...
                        <Select
                          ...
                          styles={{
                            control: (base) => ({
                              ...base,
                              borderColor: getFieldError("saudi_office_id")
                                ? "#dc3545"
                                : base.borderColor,
                            }),
                            option: (base, state) => {
                      ...
                      <Form.Group className="mb-3">
                        ...
                        <Select
                          ...
                          styles={{
                            control: (base) => ({
                              ...base,
                              borderColor: getFieldError("external_office_id")
                                ? "#dc3545"
                                : base.borderColor,
                            }),
                            option: (base, state) => {
                      ...
                      <Form.Group className="mb-3">
                        ...
                        <Select
                          ...
                          styles={{
                            control: (base) => ({
                              ...base,
                              borderColor: getFieldError("service_type")
                                ? "#dc3545"
                                : base.borderColor,
                            }),
                          }}
                  ...
                  <Row>
                      ...
                      <Form.Group className="mb-3">
                        ...
                        <Select
                          ...
                          styles={{
                            control: (base) => ({
                              ...base,
                              borderColor: getFieldError("nationality")
                                ? "#dc3545"
                                : base.borderColor,
                            }),
                          }}
                    ...
                    <Col md={6}>
                      <Form.Group className="mb-3">
                        ...
                        <Select
                          classNamePrefix="react-select"
                          options={arrivalDestinationOptions
                            .filter(
                              (destination) =>
                                !formData.nationality ||
                                destination.nationality_key ===
                                  formData.nationality,
                            )
                            .map((destination) => ({
                          ...
                          value={
                            arrivalDestinationOptions.find(
                              (destination) =>
                                destination.key ===
                              ...
                              ? {
                                  ...
                                  label: arrivalDestinationOptions.find(
                                    (destination) =>
                                      destination.key ===
                                        formData.arrival_destination ||
                                      destination.label ===
                          ...
                          onChange={(option) =>
                            setFormData((prev) => ({
                              ...prev,
                              arrival_destination: option?.value || "",
                            }))
                          }
                          placeholder={
                            formData.nationality
                      ...
                      <Form.Group className="mb-3">
                        ...
                        <Select
                          ...
                          onChange={(option) =>
                            setFormData((prev) => ({
                              ...prev,
                              profession: option ? option.value : "",
                            }))
                          }
                          ...
                          styles={{
                            control: (base) => ({
                              ...base,
                              borderColor: getFieldError("profession")
                                ? "#dc3545"
                                : base.borderColor,
                            }),
                          }}
                    ...
                    <Col md={6}>
                      <Form.Group className="mb-3">
                        ...
                        <Form.Control
                          ...
                          onChange={handleChange}
                          isInvalid={!!getFieldError("birth_date")}
                          className="rounded-3"
                        />
                        <Form.Control.Feedback type="invalid">
                      ...
                      <Form.Group className="mb-3">
                        ...
                        <Select
                          ...
                          styles={{
                            control: (base) => ({
                              ...base,
                              borderColor: getFieldError("status")
                                ? "#dc3545"
                                : base.borderColor,
                            }),
                          }}
                    ...
                    <Col md={6}>
                      <Form.Group className="mb-3">
                        ...
                        <Form.Control
                          ...
                          onChange={handleChange}
                          disabled={formData.is_paid_by_office}
                    ...
                    <Col md={6}>
                      <Form.Group className="mb-3">
                        ...
                        <Form.Control
                          ...
                          readOnly
                          disabled
                          className={`rounded-3 fw-bold text-start ${priceDifference >= 0 ? "text-success bg-success bg-opacity-10" : "text-danger bg-danger bg-opacity-10"}`}
                          dir="ltr"
                        />
                      </Form.Group>
                    </Col>
                    ...
                    <Col md={12}>
                      <Form.Group className="mb-3">
                        <Form.Check
                          ...
                          checked={formData.is_paid_by_office || false}
                          onChange={handleChange}
                        />
                      </Form.Group>
                    </Col>
      ...
      >
        ...
        <Modal.Footer className="border-0 pb-4 px-4">
          ...
          <Button
            ...
            className="px-3 rounded-3"
          >
            {quickEmployeeLoading ? "جاري الإضافة..." : "حفظ وتحديد"}
          </Button>
        </Modal.Footer>
      </Modal>
    </>
