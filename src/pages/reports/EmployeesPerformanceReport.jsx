...
const EmployeesPerformanceReport = () => {
  ...
  const {
    items: sortedModalOrders,
    requestSort: requestModalSort,
    sortConfig: modalSortConfig,
  } = useSortableData(selectedEmployeeForModal?.orders || []);
        ...
        <div className="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
          <div>
            ...
            <p className="text-muted mb-0 small">
              تحليل تفصيلي لإنتاجية ومبيعات ونسبة مساهمة الموظفين والمسوقين في
              عقود ومبيعات الفترة المحددة
            </p>
          </div>
            ...
            >
              <Card.Body className="p-4 d-flex justify-content-between align-items-center">
                <div>
                  ...
                  <h2 className="mb-0 fw-extrabold display-6">
                    {kpis.total_period_orders || 0}{" "}
                    <span className="fs-6 font-normal">عقد</span>
                  </h2>
                </div>
                <div
            ...
            >
              <Card.Body className="p-4 d-flex justify-content-between align-items-center">
                <div>
                  ...
                  <h3 className="mb-0 fw-extrabold fs-4">
                    {(kpis.total_period_sales || 0).toLocaleString()}{" "}
                    <span className="fs-7 font-normal">ر.س</span>
                  </h3>
                </div>
                <div
                  className="bg-white bg-opacity-20 rounded-circle p-3 d-flex align-items-center justify-content-center"
              ...
              <Card.Body className="p-4 d-flex justify-content-between align-items-center">
                <div>
                  ...
                  <h2 className="mb-0 fw-extrabold display-6">
                    ...
                    <span className="fs-6 font-normal">
                ...
                <Table hover align="middle" className="mb-0 text-center">
                  <thead className="bg-light text-secondary border-bottom">
                    <tr>
                      ...
                      <SortableHeader
                        title="نسبة المساهمة %"
                        sortKey="orders_share_percentage"
                        sortConfig={sortConfig}
                        onRequestSort={requestSort}
                        className="py-3"
                        ...
                        <tr key={emp.id || idx}>
                          <td className="fw-bold text-dark text-end ps-3">
                            <div className="d-flex align-items-center gap-2">
                              <div
                                className="avatar-circle bg-primary-subtle text-primary fw-bold rounded-circle d-flex align-items-center justify-content-center"
                                style={{
                                  width: "36px",
                                  height: "36px",
                                  fontSize: "0.9rem",
                          ...
                          <td>
                            <Badge
                              bg="secondary"
                              className="px-2 py-1 bg-opacity-75"
                            >
                              {emp.position}
                            </Badge>
                          </td>
                          ...
                          <td>
                            <div className="d-flex align-items-center gap-2 justify-content-center">
                              <ProgressBar
                                now={emp.orders_share_percentage}
                                variant="info"
                                style={{ width: "60px", height: "6px" }}
                                className="rounded-pill"
                              />
                              <span className="small fw-bold">
                                {emp.orders_share_percentage}%
                              </span>
                            </div>
                          </td>
                          <td>
                          ...
                          <td className="fw-bold text-success">
                            {(emp.total_sales || 0).toLocaleString()} ر.س
                          </td>
                          <td>
                            <div className="d-flex align-items-center gap-2 justify-content-center">
                              <ProgressBar
                                now={emp.completion_rate}
                                variant={
                ...
                <div className="bg-light p-3 rounded-3 mb-4 d-flex flex-wrap justify-content-between align-items-center gap-2 border">
                  <div>
                    ...
                    <strong className="text-dark me-3">
                      {selectedEmployeeForModal.position}
                    </strong>
                    <span className="text-muted ms-2">المكتب:</span>
                    <strong className="text-dark">
                      {selectedEmployeeForModal.office_name}
                    </strong>
                  </div>
                  <div className="d-flex gap-3">
                    ...
                    <Badge bg="success" className="px-3 py-2 fs-7">
                      إجمالي القيمة:{" "}
                      {(
                        selectedEmployeeForModal.total_sales || 0
                      ).toLocaleString()}{" "}
                      ر.س
                    </Badge>
                  </div>
                ...
                {sortedModalOrders.length === 0 ? (
                  ...
                  <div className="table-responsive">
                    <Table
                      hover
                      align="middle"
                      className="mb-0 text-center border"
                    >
                      <thead className="bg-light text-secondary">
                        <tr>
                          <SortableHeader
                            ...
                            sortKey="id"
                            sortConfig={modalSortConfig}
                            onRequestSort={requestModalSort}
                          />
                          <SortableHeader
                            title="اسم العميل / المستفيد"
                            sortKey="client_name"
                            sortConfig={modalSortConfig}
                            onRequestSort={requestModalSort}
                          />
